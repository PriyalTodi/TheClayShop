...
function dynamicContentDetails(ob)
{
    ...
    buttonText = document.createTextNode('Add to Favourite')
    ...
    httpRequest.onreadystatechange = function()
    {
        if(this.readyState === 4 && this.status == 200)
        {
            ...
            let contentDetails = JSON.parse(this.responseText)
            {
                ...
                dynamicContentDetails(contentDetails[id-1])
            }
        }
        else
        {
...
httpRequest.open('GET', 'http://127.0.0.1:5500/product.json', true)
httpRequest.send()  
